...
import { schema as createSchema } from "../../schemas/createSchema";
import { yupResolver } from "@hookform/resolvers/yup";
import { TextField, Button } from "@mui/material";
import { IdData, IPatient } from "../../interfaces/index";
import { usePatient } from "../../providers/patients";

const ModalCreate = (id: IdData) => {
  const { addPatient } = usePatient();
  const {
    register,
    handleSubmit,
    formState: { errors },
  } = useForm<IPatient>({ resolver: yupResolver(createSchema) });

  return (
    <Background>
      <ModalUpdate>
        <Subtitle>Adicionar paciente</Subtitle>
